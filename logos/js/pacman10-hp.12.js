...
*/
  ...
  na('Promise', function (a) {
    ...
    e.prototype.Ra = function (h) {
      ...
      typeof g == 'function' ? this.hb(g, h) : this.U(h);
    };
    ...
    e.prototype.W = function (h, g) {
      if (this.i != 0) throw Error('b`' + h + '`' + g + '`' + this.i);
      this.i = h;
      this.j = g;
      this.Ka();
    };
    ...
    e.prototype.then = function (h, g) {
      function k(U, pa) {
        return 'function' === typeof U ? function ($b) {
          try {
            l(U($b));
          } catch (ac) {
            q(ac);
    ...
    e.all = function (h) {
      ...
      return k.done ? c([]) : new e(function (l, q) {
        ...
        var U = [];
        var pa = 0;
        do U.push(void 0), pa++, c(k.value).yb(L(U.length - 1), q), k = g.next(); while (!k.done);
      });
    };
    return e;
  });
  ...
  na('WeakMap', function (a) {
    ...
    function c(k) {
      var l = typeof k;
      return 'object' === l && k !== null || 'function' === l;
    }
    ...
    if (function () {
        ...
        try {
          ...
          if (q.get(k) != 2 || q.get(l) != 3) return !1;
          q.delete(k);
          q.set(l, 4);
          return !q.has(k) && q.get(l) == 4
        } catch (L) {
          return !1;
        }
      }()) return a;
    ...
    g.prototype.delete = function (k) {
      return c(k) &&
        va(k, f) && va(k[f], this.g) ? delete k[f][this.g] : !1;
    };
    return g;
  });
  na('Map', function (a) {
    if (function () {
        ...
        try {
          ...
          q = l.next();
          return q.done || q.value[0].x != 4 || 't' != q.value[1] || !l.next().done ? !1 : !0;
        } catch (L) {
          return !1;
        }
      }()) return a;
    ...
    c.prototype.set = function (g, k) {
      ...
      l.Ma ? l.Ma.value = k : (l.Ma = {
        ...
        key: g,
        value: k
      }, l.list.push(l.Ma), this.g.Wa.next = l.Ma, this.g.Wa = l.Ma, this.size++);
      return this;
    };
    c.prototype.delete = function (g) {
      g = d(this, g);
      return g.Ma && g.list ? (g.list.splice(g.index, 1), g.list.length || delete this.i[g.id], g.Ma.Wa.next = g.Ma.next, g.Ma.next.Wa = g.Ma.Wa,
        g.Ma.head = null, this.size--, !0) : !1;
    };
    ...
    c.prototype.forEach = function (g, k) {
      for (var l = this.entries(),
          q; !(q = l.next()).done;) q = q.value, g.call(k, q[1], q[0], this);
    };
  ...
  var Da = Array.prototype.indexOf ? function (a, b) {
    ...
    if (typeof a === 'string') return 'string' !== typeof b || b.length != 1 ? -1 : a.indexOf(b, 0);
  ...
  La[' '] = xa;
  var Ma = m(n, 'Opera');
  var Na = m(n, "Trident") || m(n, "MSIE");
  var Oa = m(n, "Edge");
  var Pa = m(n, "Gecko") && !(m(n.toLowerCase(), "webkit") && !m(n, "Edge")) && !(m(n, "Trident") || m(n, "MSIE")) && !m(n, "Edge");
  var Qa = m(n.toLowerCase(), "webkit") && !m(n, "Edge");
  var Ra = function () {
    var a = wa.document;
  ...
  if (cb = Na) {
    ...
    if (Object.prototype.hasOwnProperty.call(Xa, '9')) db = Xa['9'];
      ...
      for (var eb = 0, fb = Ha(String(Wa)).split('.'), gb = Ha('9').split('.'), hb = Math.max(fb.length, gb.length), ib = 0; eb == 0 && ib < hb; ib++) {
        var jb = fb[ib] || '';
        var kb = gb[ib] || '';
        do {
          var lb = /(\d*)(\D*)(.*)/.exec(jb) || ['', '', '', ''];
          var mb = /(\d*)(\D*)(.*)/.exec(kb) || ['', '', '', ''];
          if (lb[0].length == 0 && mb[0].length == 0) break;
          eb = Ia(lb[1].length == 0 ? 0 : parseInt(lb[1], 10), mb[1].length == 0 ? 0 : parseInt(mb[1], 10)) || Ia(lb[2].length == 0, mb[2].length == 0) || Ia(lb[2], mb[2]);
          jb = lb[3];
          kb = mb[3];
        } while (eb == 0);
      }
  ...
  xb.prototype.add = function (a, b, c, d, e) {
    ...
    h > -1 ? (b = a[h], c || (b.Eb = !1)) : (b = new vb(b, this.src, f, !!d, e), b.Eb = c, a.push(b));
    return b;
  };
  var yb = function (a, b) {
    var c = b.type;
    if (c in a.g) {
      ...
      f && (wb(b), a.g[c].length == 0 && (delete a.g[c], a.i--));
    }
  };
  ...
  var Eb = function (a, b, c, d, e) {
    if (Array.isArray(b))
      ...
      if (!c.g) {
        ...
        e.listener =
          c;
        if (a.addEventListener) ob || (d = f), void 0 === d && (d = !1), a.addEventListener(b.toString(), e, d);
  ...
  var Ib = function (a, b) {
    ...
    var d = a.i || a.src;
    if (a.Eb &&
      'number' !== typeof a && a && !a.ub) {
      var e = a.src;
      if (e && e[tb]) yb(e.g, a);
      else {
        var f = a.type;
        var h = a.g;
        e.removeEventListener ? e.removeEventListener(f, h, a.capture) : e.detachEvent ? e.detachEvent(Hb(f), h) : e.addListener && e.removeListener && e.removeListener(h);
        Bb--;
  ...
  var Tb = function (a) {
    a.g && (a.i == null ? Sb(a) : void 0 === a.i.playbackState ? Sb(a) : a.i.playbackState !== a.i.PLAYING_STATE && a.i.playbackState !== a.i.FINISHED_STATE && Sb(a));
  };
  ...
  p.prototype.play = function (a, b, c, d, e, f) {
    ...
    this.v ? (this.j ? this.j.connect(this.v) : d.connect(this.v), this.v.connect(this.w)) : this.j ? this.j.connect(this.w) : d.connect(this.w);
    this.j = null;
    d.loop =
      b;
    try {
    ...
    b ? (d.loopStart = a + (e ? c / 1E3 : 0), d.loopEnd = a + h, d.start(f, a + c / 1E3)) : d.start(f, a + c / 1E3, h);
    e = this.Ka++;
    this.i[e] = {
      node: d,
      Jb: 1E3 * f - c,
  ...
  var Yb = "function" == ya(Xb.canPlayType) && "" != Xb.canPlayType('audio/mpeg') ? ".mp3" : '.ogg';
  var Zb = function (a, b) {
    Ba.call(this, a + b + Yb);
    this.j = this.w = null;
    this.g = 0;
  ...
  Zb.prototype.preload = function (a, b) {
    ...
    a && Ca(this, a);
    if (this.g != 0) return Promise.resolve();
  ...
  var ec = function (a) {
    ...
    this.U = !1;
    var b;
    a instanceof ec ? (this.U = a.U, fc(this, a.v), this.W = a.W, this.j = a.j, gc(this, a.Ka), this.g = a.g, hc(this, ic(a.i)), this.w = a.w) : a && (b = String(a).match(Ob)) ? (this.U = !1, fc(this, b[1] || '', !0), this.W = jc(b[2] || ''), this.j = jc(b[3] || '', !0), gc(this, b[4]), this.g = jc(b[5] || '', !0), hc(this, b[6] || '', !0), this.w = jc(b[7] || '')) : (this.U = !1, this.i = new r(null, this.U));
  };
  ec.prototype.toString = function () {
    ...
    b && a.push(kc(b, lc, !0), ':');
    var c = this.j;
    if (c || 'file' == b) a.push('//'), (b = this.W) && a.push(kc(b, lc, !0), '@'), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, '%$1')), c = this.Ka, c != null && a.push(':', String(c));
    if (c = this.g) this.j && '/' != c.charAt(0) && a.push('/'), a.push(kc(c, '/' == c.charAt(0) ? mc : nc, !0));
    ...
    if (c) gc(b, a.Ka);
      ...
      if (e == '..' || '.' == e) d = '';
        ...
        for (var f = [], h = 0; h < e.length;) {
          var g = e[h++];
          '.' == g ? d && h == e.length && f.push('') : '..' == g ? ((f.length > 1 || f.length == 1 && '' != f[0]) && f.pop(),
            d && h == e.length && f.push('')) : (f.push(g), d = !0);
        }
        d = f.join('/');
      } else d = e;
    }
  ...
  var sc = function (a) {
    a.g || (a.g = new Lb(), a.i = 0, a.j && Pb(a.j, function (b, c) {
  ...
  var uc = function (a, b) {
    sc(a);
    b = tc(a, b);
    Nb(a.g.i, b) && (a.j = null, a.i -= a.g.get(b).length, a = a.g, Nb(a.i, b) && (delete a.i[b], a.j--, a.g.length > 2 * a.j && Mb(a)));
  };
  var vc = function (a, b) {
    sc(a);
    b = tc(a, b);
  ...
  r.prototype.v = function (a) {
    sc(this);
    var b = [];
    if (typeof a === 'string') vc(this, a) && (b = Fa(b, this.g.get(tc(this, a))));
    else {
      a = this.g.v();
  ...
  var pc = function (a, b) {
    b && !a.w && (sc(a), a.j = null, a.g.forEach(function (c, d) {
      var e = d.toLowerCase();
      d != e && (uc(this, d), uc(this, e), c.length > 0 && (this.j = null, this.g.set(tc(this, e), Ga(c)), this.i += c.length));
    }, a));
    a.w = b;
  };
  var t = navigator.userAgent;
  var wc = new ec(location.href);
  var xc = "MacIntel" === navigator.platform && 1 < navigator.maxTouchPoints;
  var yc = m(t, "iPad") || m(t, "iPhone") || m(t, "iPod") || xc;
  var zc = (m(t.toLowerCase(), "gsa") || m(t, "GoogleApp")) && !yc;
  var Ac = yc || m(t, 'Android') || m(t, 'Mobile') || m(t, 'Silk') || m(t, 'UCBrowser') || m(t, 'UCWEB');
  var Bc = Date.now;
  var Cc = ['', "moz", "ms", "o", "webkit"];
  var Dc = function (a) {
    var b = document;
    if (!b) return null;
  ...
  var Ic = function (a, b, c) {
    ...
    this.ab = Bc();
    this.mb = Dc('hidden');
    this.i = (this.Ra = Dc('visibilityState')) ? this.Ra.replace(/state$/i, 'change').toLowerCase() : null;
    this.v = Fc(this);
    this.w = !1;
    this.U = this.v;
    Gc(this);
  ...
  var Kc = function (a, b) {
    window.agsa_ext ? b() : a.Bb = window.setTimeout(function () {
      Gc(a);
    }, 100);
  };
  ...
  var Fc = function (a) {
    if (!a.mb && !a.Ra && window.agsa_ext && window.agsa_ext.getPageVisibility) return 'hidden' == window.agsa_ext.getPageVisibility();
    var b = document[a.Ra];
  ...
  var Yc = function () {
    ...
    if (a && (!a.timestamp ||
      ...
      if (Rc.length)
        for (var c in Qc) {
          a = Qc[c];
          var d = b[a];
          if (typeof d != 'undefined' && d != Rc[a] && Sc[a]) {
            Vc && Vc();
    ...
    Wc && (window.requestAnimationFrame ? window.requestAnimationFrame(Yc) : window.oRequestAnimationFrame ? window.oRequestAnimationFrame(Yc) : window.mozRequestAnimationFrame ? window.mozRequestAnimationFrame(Yc) : window.msRequestAnimationFrame ? window.msRequestAnimationFrame(Yc) : window.webkitRequestAnimationFrame && window.webkitRequestAnimationFrame(Yc));
  };
  var v = function () {
  ...
  var De = function (a) {
    ...
    b = a.hb[1] + 10 - b;
    c = a.hb[0] + 40 - c;
    "pcm-bpcm" == a.s && 4 == a.dir ? (y.save(), y.translate(b + d / 2, c), y.scale(-1, 1), W(f, h, d, e, -d / 2, 0), y.restore()) : 'pcm-swipe' == a.s ? (a = y.createLinearGradient(b, 0, b + d, 0), a.addColorStop(0, "rgba(104, 186, 253, 1)"), a.addColorStop(1, "rgba(104, 186, 253, 0)"), y.fillStyle = a, y.fillRect(b, c, d, e)) : W(f, h, d,
      e, b, c)
  };
  var He = function (a, b) {
    var c = a.mode;
  ...
  var Ke = function (a, b) {
    ...
    var f = C[e[0]][e[1]];
    b && !f.Va && (f = C[c[0]][c[1]]);
    if (f.Va) switch (a.mode) {
      case 2:
      case 1:
      case 8:
        if ((a.dir &
            f.La) == 0 && f.La == B[a.dir]) a.g = B[a.dir];
        else {
          b = 99999999999;
        ...
        break;
      case 4:
        if ((a.dir & f.La) == 0 && f.La == B[a.dir]) a.g = B[a.dir];
        else {
          do e = pe[Math.floor(4 * Ie())]; while ((e & f.La) == 0 || e == B[a.dir]);
          a.g = e
        }
    }
  };
  var Ne = function (a) {
    if (a.v == -1 || a.Ra) {
      a: {
        ...
        b = ze[a.j][a.v];a.o[0] = 8 * b.y;a.o[1] = 8 * b.x;a.dir = b.dir;a.Ka = 0;a.Ta = Le(b.speed);a.Ra = !1;Me(a)
      }
    }
  ...
  var Te = function (a) {
    if (a.dir && a.Ta[hd]) {
      ...
      if (b[0] != a.S[0] || b[1] != a.S[1]) {
        ...
        a.H || C[b[0]][b[1]].path ? a.W = [b[0], b[1]] : (a.o[0] = a.W[0], a.o[1] = a.W[1], b[0] = a.W[0], b[1] = a.W[1], a.dir = 0);
        C[b[0]][b[1]].type == 1 && a.mode != 8 ? Oe(a, 2) : Oe(a, 0);
        if (!a.H &&
          C[b[0]][b[1]].Pa) {
          c = a.id;
          D--;
          ...
          Oe(E[c], 1);
          Pe(c);
          C[b[0]][b[1]].Pa == 2 ? (Qe(4, !1), Re(50, c)) : Re(10, c);
          C[b[0]][b[1]].Pa = 0;
          Ee();
          Wd = 90 * A.wa;
          if (Sd) switch (Td++, Td) {
              ...
              case qe[3]:
                E[z + 3].mode == 16 && (Sd = !1);
            } else if (E[z + 1].mode == 16 || E[z + 1].mode == 8) E[z + 1].lb++, E[z + 1].lb >= A.ya[1] && (E[z + 1].Ua = !0);
            else if (E[z + 2].mode == 16 || E[z + 2].mode == 8) E[z + 2].lb++, E[z + 2].lb >= A.ya[2] && (E[z + 2].Ua = !0);
          else if (E[z + 3].mode == 16 || E[z + 3].mode == 8) {
            E[z + 3].lb++, E[z + 3].lb >= A.ya[3] && (E[z +
              3].Ua = !0);
          }
          if (rd == 70 || rd == 170) Xd = !0, Ed = H[15] + (H[16] - H[15]) * Ie();
          D == 0 && Y(9);
          X();
        }
        a.S[0] = b[0];
      ...
      if (!a.H && a.g && C[b[0]][b[1]].Va && a.g & C[b[0]][b[1]].La) {
        ...
        a.o[0] >= e[0] && a.o[0] <= f[0] && a.o[1] >= e[1] && a.o[1] <= f[1] && (e =
          S[a.g], a.Qa[e.axis] += e.Na);
      }
      Me(a);
    }
  };
  Ce.prototype.move = function () {
    if (F == 0 || this.H && F == 1 && (this.mode == 8 || this.mode == 64)) {
      if (this.Oa != 0) {
        a: {
          var a = this.Oa;cd || (google.doodle.pacManSound = !0, Ue());
          if (this.dir == B[a]) this.dir = a,
          this.Qa = [0, 0],
          this.ab != 2 && Oe(this, 0),
          this.dir != 0 && (this.U = this.dir),
          this.g = 0;
          else if (this.dir != a) {
            if (this.dir == 0) C[this.o[0]][this.o[1]].La & a && (this.dir = a);
            else {
              ...
              if (b && b.La & a) {
                ...
                c[b.axis] -= b.Na;
                var d = 0;
                c[0] == this.S[0] && c[1] == this.S[1] ? d = 1 : (c[b.axis] -=
                  b.Na, c[0] == this.S[0] && c[1] == this.S[1] && (d = 2));
                if (d) {
                  this.dir = a;
                  this.o[0] = this.S[0];
                  this.o[1] = this.S[1];
      ...
      this.w ? (Ne(this), this.mode == 64 && Ne(this)) : (Te(this), this.mode == 8 && Te(this));
    }
  };
  var Ve = function (a) {
  ...
  var Me = function (a) {
    ...
    if (F == 8 || F == 14) var b = [0, 3];
      ...
      if (F == 10 || F == 4 || F == 3) {
        ...
        c = 11
      } else if (a.mode != 4 && (a.mode != 16 && a.mode != 32 || fd != 4 || a.nb))
        if (a.mode == 8 || a.mode == 64) {
          c = a.g;
          c || (c = a.dir);
          switch (c) {
            case 4:
        ...
        a.s) b = 6, c = 9 + Math.floor(I / 16) % 2;
      else if ('pcm-ghfa' == a.s) b = 3 == K ? 6 : 7, c = 11;
      else if ('pcm-stck' == a.s) b = 1 == K ? 60 < nd ? 1 : nd > 45 ? 2 : 3 : K == 2 ? 3 : K == 3 || K == 4 ? 4 : 0, c = 13;
      else {
        c = a.g;
        ...
        c = 4 + a.id - z;
        if (a.speed > 0 || F != 13) b += Math.floor(I / 16) % 2
      } else b = 0, c = 8, J < A.Fb - A.$ && 0 == Math.floor(J / H[1]) % 2 && (b += 2), b += Math.floor(I / 16) % 2;
      b = [c, b]
    } else {
      c = b = 0;
      var d = a.dir;
      0 == d && (d = a.U);
      if (F == 1 && a.id == jd) b = 3, c = 0;
      else if (F != 9 && F != 10 || a.id != 0)
        if (F ==
          4 || F == 5 || F == 7) b = 0 == a.id ? 2 : 4, c = 0;
        else if (F == 3)
        if (a.id == kd)
      ...
      else if ('pcm-bpcm' == a.s) b = 14, c = Math.floor(0.2 *
        I) % 4, 3 == c && (c = 1), c *= 2;
  ...
  var Je = function (a, b) {
    return Math.sqrt((b[1] - a[1]) * (b[1] - a[1]) +
      (b[0] - a[0]) * (b[0] - a[0]))
  };
  var We = function () {
    E = [];
    for (var a = 0; a < z + 4; a++) E[a] = new Ce(a), a < z ? (E[a].H = !1, E[a].mode = 1) : E[a].H = !0
  };
  var Ye = function (a) {
    Mc(sd);
    a || (a = window.event);
  ...
  var Ze = function (a, b) {
    ...
    var f = Math.abs(a - d);
    var h = Math.abs(b - e);
    8 < f && h < f ? c.Oa = a > d ? 8 : 4 : h > 8 && f < h && (c.Oa = b > e ? 2 : 1)
  };
  var $e = function (a) {
    Mc(sd);
    a || (a = window.event);
  ...
  var cf = function (a) {
    Mc(sd);
    ud = td = 0;
    1 == a.touches.length && (vd = a.touches[0].pageX,
      wd = a.touches[0].pageY, document.addEventListener('touchmove', af, !0), document.addEventListener('touchend', bf, !0));
    a.preventDefault()
  };
  var af = function (a) {
    Mc(sd);
  ...
  var bf = function (a) {
    Mc(sd);
    if (td == 0 && ud == 0) Ze(vd, wd);
    else {
      var b = Math.abs(td);
      var c = Math.abs(ud);
      8 > b && 8 > c ? Ze(vd, wd) : b > 15 && c < 2 * b / 3 ? E[0].Oa = 0 < td ? 8 : 4 : c > 15 && b < 2 * c / 3 && (E[0].Oa = 0 < ud ? 2 : 1);
  ...
  var ff = function (a) {
    ...
    C = [];
    for (b = 0; b <= qd + 1; b++)
      for (C[8 * b] = [], c = -2; c <= pd + 1; c++) C[8 * b][8 * c] = {
        path: 0,
        Pa: 0,
        Va: 0
      };
    for (b = 0; b < re.length; b++) {
      ...
      var d = c.type;
      if (c.T) {
        for (var e = 8 * c.y, f = 8 * c.x; f <= 8 * (c.x + c.T - 1); f += 8) C[e][f].path = !0, 0 == C[e][f].Pa && (C[e][f].Pa = 1, D++), !d || f != 8 * c.x && f != 8 * (c.x + c.T - 1) ? C[e][f].type = d : C[e][f].type = 0;
        C[e][8 * c.x].Va = !0;
        C[e][8 * (c.x + c.T - 1)].Va = !0
      } else {
        f = 8 * c.x;
        for (e = 8 * c.y; e <= 8 * (c.y + c.h - 1); e += 8) C[e][f].path && (C[e][f].Va = !0), C[e][f].path = !0, 0 == C[e][f].Pa && (C[e][f].Pa = 1, D++), !d || e != 8 * c.y && e != 8 * (c.y + c.h - 1) ? C[e][f].type = d : C[e][f].type = 0;
        C[8 * c.y][f].Va = !0;
    ...
    for (b = 0; b < T.length; b++)
      if (T[b].T)
        for (f =
          8 * T[b].x; f <= 8 * (T[b].x + T[b].T - 1); f += 8) C[8 * T[b].y][f].Pa = 0, D--;
      else
        for (e = 8 * T[b].y; e <= 8 * (T[b].y + T[b].h - 1); e += 8) C[e][8 * T[b].x].Pa = 0, D--;
    for (b = 8; b <= 8 * qd; b += 8)
      for (c = 8; c <= 8 * pd; c += 8) C[b][c].La = 0, C[b - 8][c].path && (C[b][c].La += 1), C[b + 8][c].path && (C[b][c].La += 2), C[b][c - 8].path && (C[b][c].La += 4), C[b][c + 8].path && (C[b][c].La += 8);
      ...
      for (var c = 0; c < E.length; c++) {
        ...
        switch (a) {
          ...
          case 2:
            ...
            break;
          case 4:
            Ud = .8 * A.Ia, Vd = .8 * A.Ba, J = A.Fb, md = 1
        }
        for (c = 0; c < E.length; c++)
          if (d = E[c], d.H) {
            if (a == 64 || b || (d.Ib = !0), 4 == a && (d.nb = !1), 8 != d.mode && 16 != d.mode && 32 != d.mode && 128 != d.mode && 64 != d.mode || b) b || 4 == d.mode || d.mode == a || (d.Db = !0), He(d, a)
          } else d.rb = Ud, d.ma = Vd, d.wb = Ud, Ge(d)
      }
  };
  var lf = function (a) {
    return [a <= 4 ? 128 : 160, 128 + (a - 1) % 4 * 16]
  };
  var Ee = function () {
    var a = .8 * A.ua;
    if (!ed || 16 != E[z + 3].mode) {
      var b = A;
      D < b.Ca ? a = .8 * b.Ea : D < b.Aa && (a = .8 *
        b.Da)
    }
    a != id && (id = a, Ge(E[z]))
  };
  var Le = function (a) {
    if (!Zd[a]) {
      ...
      var c = 0;
      Zd[a] = [];
      for (var d = 0; 90 > d; d++) b += a, Math.floor(b) > c ? (Zd[a].push(!0), c = Math.floor(b)) : Zd[a].push(!1)
    }
    return Zd[a]
  };
  var Y = function (a) {
    ...
    switch (a) {
      ...
      case 13:
        ...
        J = A.Fb;
        ae = [];
        for (var c in $d.$a) a = $d.$a[c].id, 0 < a && (a += z - 1), a = new Ce(a), a.o = [8 * $d.$a[c].y, 8 * $d.$a[c].x], a.Qa = [0, 0], a.H = $d.$a[c].H, ae.push(a);
        mf();
        Z();
        X()
    }
  ...
  var nf = function (a) {
    a = window.event || a;
    a.cancelBubble = !0;
    google.doodle.pacManSound ? (cd = !0, Z(), google.doodle.pacManSound = !1) : (cd = !1, google.doodle.pacManSound = !0, X());
    var b = !cd;
    if (Oc) try {
  ...
  var Ue = function () {
    P && (P.style.backgroundPosition = google.doodle.pacManSound ? "-216px -105px" : '-236px -105px')
  };
  var ef = function () {
    yd = !1;
    O = !0;
  ...
  var of = function () {
    13 != F && (I % (2 * H[17]) == 0 ? Od = !0 : I % (2 * H[17]) == H[17] && (Od = !1))
  };
  var pf = !1;
  var qf = !1;
  var rf = function () {
    ...
    Q += a - be - Be;
    100 < Q ? Q = 100 : Q < -100 && (Q = -100);
    var b = 0;
    Q > Be ? (b = Math.floor(Q / Be), Q -= Be * b) : Q < -Be && (b = Math.ceil(Q / Be), Q -= Be * b);
    b = 1 + b;
    be = a;
    if (F == 13) {
      for (a = 0; a < b; a++) {
      ...
      for (a = 0; a < b; a++) {
          ...
          a: for (dd = !1, d = z; d < z + 4; d++)
            for (c = 0; c < z; c++)
              if (E[d].S[0] == E[c].S[0] && E[d].S[1] == E[c].S[1]) {
                ...
                8 != E[d].mode && 16 != E[d].mode && 32 != E[d].mode && 128 != E[d].mode && 64 != E[d].mode && (kd = c, Y(2))
              }for (c = z; c < z + 4; c++)
            if (d = E[c], d.id == z && D < A.Aa && 2 == d.mode && (!ed || 16 != E[z + 3].mode)) e = E[d.Cb], d.i = [e.S[0], e.S[1]];
            else if (d.H && 1 == d.mode) switch (e = E[d.Cb], d.id) {
            case z:
              d.i = [e.S[0], e.S[1]];
              break;
            case z + 1:
        ...
        if (0 == F) {
          ...
          else if (0 < Gd && (Gd--, 0 >= Gd && (Gd = 0, Fd++, A.ta[Fd]))) switch (Gd = 90 * A.ta[Fd], fd) {
            case 2:
              Qe(1, !1);
              break;
            case 1:
    ...
    if (O) {
      if (Jd) {
        ...
        b.beginPath();
        for (d = 8; d <= 8 * qd; d += 8)
          for (e = 8; e <= 8 * pd; e += 8) C[d][e].Pa == 1 && b.rect(e + -32 + 10 + 3, d + 0 + 40 + 3, 2, 2);
        b.fill();
        if (Nd)
          for (d = 8; d <= 8 * qd; d += 8)
            for (e = 8; e <= 8 * pd; e += 8) C[d][e].Pa == 2 && (a = e + -32 + 10, c = d + 0 + 40, W(2, 182, 8, 8, a, c));
        Kd && (b.fillStyle = "#ffaaa5", b.fillRect(289, 86, 19, 2));
        if (Xd || Yd) a = Yd ? [128, 16 * (A.ka - 1)] : lf(A.ka), d = a[0] / 8 * 10 + 2, e = a[1] / 8 * 10 + 2, a = we[1] + -32 + 10 - 8, c = we[0] + 0 + 40 - 4, W(d, e, 32, 16, a, c);
        if (F == 1) {
          for (a = 0; a < E.length; a++) a != ld && De(E[a]);
          De(E[ld])
        } else
          for (a = 0; a < E.length; a++) De(E[a])
      }
      ...
      if (Id) {
        ...
        Rd = 0;
        for (a = 280; 472 >= a; a += 8)
          for (c = 0; 136 >= c; c += 8) 0.03 > Ie() && (Qd = 10 * Math.floor(25 * Ie()), Rd = 10 * Math.floor(2 * Ie())), W(Qd, Rd, 8, 8, a + 10, c + 40), Rd += 8;
        b.restore()
      }
      sf();
  ...
  var Re = function (a, b) {
    Ad[b] += a;
    !Bd[b] && 1E4 < Ad[b] && (Se('extra-life'), Bd[b] = !0, Cd++, 5 <
      Cd && (Cd = 5))
  };
  var Se = function (a) {
  ...
  var Pe = function (a) {
    ge && google.doodle.pacManSound && 0 == F && (ee[a] ? fe[a] = !0 : (a == 0 ? (Se(Hd[a] == 1 ? 'eating-dot-1' : 'eating-dot-2'), ie = window.setInterval(uf, 150)) : (Se('eating-dot-double'), je = window.setInterval(vf, 150)), Hd[a] = 3 - Hd[a]))
  };
  var wf = function (a) {
    ee[a] = !1;
    fe[a] && (fe[a] = !1, Pe(a))
  ...
  var X =
    function () {
      if (ge && google.doodle.pacManSound) {
        var a = 0;
        0 == F || 1 == F ? a = bd ? "ambient-eyes" : fd == 4 ? 'ambient-fright' : rd > 241 ? 'ambient-4' : rd > 207 ? 'ambient-3' : rd > 138 ? 'ambient-2' : 'ambient-1' : F == 13 && zd != 0 && (a = "cutscene");
        if (a) {
          var b = !1;
  ...
  var Af = function () {
    ...
    if (me && ne && (zf(1), !le)) {
      ...
      M.tabIndex = 0;
      M.focus();
      ge && (P = document.createElement('div'), P.style.background = "url(./logos/pacman10-hp-sprite-3.png) 38px 18px no-repeat", P.style.position = "absolute", P.style.right = "0", P.style.top = "0", P.style.width = "12px", P.style.height = "12px", P.style.border = "10px solid black", P.style.cursor = "pointer", ke.appendChild(P),
        P.onclick = nf, P.addEventListener('touchstart', nf), Ue());
      Zd = [];
      B = [, 2, 1, , 8, , , , 4];
      window.addEventListener ? (window.addEventListener('keydown', Ye, !1), M.addEventListener('click', $e, !1), document.addEventListener('touchstart', cf, !0), M.addEventListener('touchstart', cf, !0), document.f && document.f.q && document.f.q.addEventListener('touchstart', cf, !0)) : (document.body.attachEvent('onkeydown', Ye), M.attachEvent('onclick', $e));
      H = {};
      for (var b in xe) H[b] = Math.round(90 * (google.doodle.pacManSound || 7 != b && 8 != b ? xe[b] : 1));
  ...
  var kf = function (a) {
    a = 'pacman,e:' + a;
    var b;
    (b = !!document.getElementById('fkbx')) || (b = wc.i.get('ntp'), b = '1' == b || '2' == b);
    b && (a += '&ntp=1');
    a.search('&ei=') == -1 && (a += '&ei=', Ec || (window.google && window.google.kEI && window.google.kEI.length ? Ec = window.google.kEI : document.querySelector('body#iframedoodle') &&
      vc(wc.i, 'ei') && (Ec = wc.i.get('ei'))), (b = Ec) && (a += b));
    window.google && window.google.log ? window.google.log('doodle', a) : dc(a);
  };
  kf('I');
  xd = le = !1;
  ...
  google.pacman.destroy = function () {
    if (google.pacman) {
      ...
      window.removeEventListener && (window.removeEventListener('MozGamepadConnected', Zc, !1), window.removeEventListener('MozGamepadDisconnected', $c, !1));
      Wc = !1;
      var a = sd;
  ...
  var Ff = navigator.userAgent.indexOf('MSIE') != -1;
  Ff || (ce.onload = Bf);
  ...
  function () {
    ...
    return a == null ? !0 : JSON.parse(a)
  }() == 0 && (cd = !0, google.doodle.pacManSound = !1);
  me = ge = !1;
  if (function () {
      var a = x.hc();
      var b = ke;
      ...
      Rb(a);
      Tb(a);
      Eb(b, ['click', 'pointerup', 'mouseup', 'touchend'], function () {
        a.g.resume();
        Tb(a);
      }, !0);
      return !0;
  ...
  Uc = ke;
  Vc = null;
  window.addEventListener && (window.addEventListener('MozGamepadConnected', Zc, !1), window.addEventListener('MozGamepadDisconnected', $c, !1));
