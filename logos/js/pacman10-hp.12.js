(function () {
  ...
  var Ma = m(n, "Opera"),
    ...
    Oa = m(n, "Edge"),
    Pa = m(n, "Gecko") && !(m(n.toLowerCase(), "webkit") && !m(n, "Edge")) && !(m(n, "Trident") || m(n, "MSIE")) && !m(n, "Edge"),
  ...
  if (cb = Na) {
    ...
    if (Object.prototype.hasOwnProperty.call(Xa, "9")) db = Xa["9"];
      ...
      for (var eb = 0, fb = Ha(String(Wa)).split("."), gb = Ha("9").split("."), hb = Math.max(fb.length, gb.length), ib = 0; 0 == eb && ib < hb; ib++) {
        var jb = fb[ib] || "",
          kb = gb[ib] || "";
        do {
          var lb = /(\d*)(\D*)(.*)/.exec(jb) || ["", "", "", ""],
          ...
          eb = Ia(0 == lb[1].length ? 0 : parseInt(lb[1], 10), 0 == mb[1].length ? 0 : parseInt(mb[1], 10)) || Ia(0 == lb[2].length, 0 == mb[2].length) || Ia(lb[2], mb[2]);
          jb = lb[3];
          kb = mb[3]
        } while (0 == eb)
      }
  ...
  xb.prototype.add = function (a, b, c, d, e) {
    ...
    a: {
      ...
      h = -1
    } - 1 < h ? (b = a[h], c || (b.Eb = !1)) : (b = new vb(b, this.src, f, !!d, e), b.Eb = c, a.push(b));
    return b
  };
  var yb = function (a, b) {
    var c = b.type;
  ...
  var Qb = function (a, b) {
    ...
    Tb = function (a) {
      a.g && (null == a.i ? Sb(a) : void 0 === a.i.playbackState ? Sb(a) : a.i.playbackState !== a.i.PLAYING_STATE && a.i.playbackState !== a.i.FINISHED_STATE && Sb(a))
    };
  ...
  ec.prototype.toString = function () {
    ...
    b && a.push(kc(b, lc, !0), ":");
    var c = this.j;
    if (c || "file" == b) a.push("//"), (b = this.W) && a.push(kc(b, lc, !0), "@"), a.push(encodeURIComponent(String(c)).replace(/%25([0-9a-fA-F]{2})/g, "%$1")), c = this.Ka, null != c && a.push(":", String(c));
    ...
    if (c) gc(b, a.Ka);
      ...
      if (".." == e || "." == e) d = "";
        ...
        for (var f = [], h = 0; h < e.length;) {
          var g = e[h++];
          "." == g ? d && h == e.length && f.push("") : ".." == g ? ((1 < f.length || 1 == f.length && "" != f[0]) && f.pop(),
  ...
  var ic = function (a) {
    ...
    pc = function (a, b) {
      b && !a.w && (sc(a), a.j = null, a.g.forEach(function (c, d) {
        var e = d.toLowerCase();
        d != e && (uc(this, d), uc(this, e), 0 < c.length && (this.j = null, this.g.set(tc(this, e), Ga(c)), this.i += c.length))
      }, a));
      a.w = b
    };
  var t = navigator.userAgent,
    ...
    Ac = yc || m(t, "Android") || m(t, "Mobile") || m(t, "Silk") || m(t, "UCBrowser") || m(t, "UCWEB");
  var Bc = Date.now,
    Cc = ["", "moz", "ms", "o", "webkit"],
    Dc = function (a) {
      var b = document;
  ...
  var y, z, ad, bd, A, cd, B, C, dd, D, ed, E, fd, gd, hd, id, F, jd, kd, G, H, I, ld, md, J, K, nd, od, pd, qd, rd, sd, M, td, ud, vd, wd, xd, yd, zd, Ad, Bd, Cd, N, Dd, Ed, Fd, Gd, Hd, Id, O, Jd, Kd, Ld, Md, Nd, Od, Pd, Qd, Rd, Sd, Td, Ud, Vd, Wd, Xd, Yd, Zd, P, $d, ae, Q, be, ce, de, ee, fe, ge, R, he, ie, je, ke, le, me, ne, oe, pe = [1, 4, 2, 8],
    S = {
      0: {
        axis: 0,
        Na: 0
      ...
      if (f.Va) switch (a.mode) {
        ...
        case 4:
          if (0 == (a.dir & f.La) && f.La == B[a.dir]) a.g = B[a.dir];
            ...
            do e = pe[Math.floor(4 * Ie())]; while (0 == (e & f.La) || e == B[a.dir]);
            a.g = e
          }
      }
    },
        ...
        if (b[0] != a.S[0] || b[1] != a.S[1]) {
          ...
          if (!a.H &&
            ...
            if (Sd) switch (Td++, Td) {
                ...
                case qe[3]:
                  16 == E[z + 3].mode && (Sd = !1)
              } else if (16 == E[z + 1].mode || 8 == E[z + 1].mode) E[z + 1].lb++, E[z + 1].lb >= A.ya[1] && (E[z + 1].Ua = !0);
              else if (16 == E[z + 2].mode || 8 == E[z + 2].mode) E[z + 2].lb++, E[z + 2].lb >= A.ya[2] && (E[z + 2].Ua = !0);
            else if (16 == E[z + 3].mode || 8 == E[z + 3].mode) E[z + 3].lb++, E[z + 3].lb >= A.ya[3] && (E[z +
              3].Ua = !0);
  ...
  var Ve = function (a) {
    ...
    Me = function (a) {
      ...
      if (8 == F || 14 == F) var b = [0, 3];
        ...
        else if ("pcm-stck" == a.s) b = 1 == K ? 60 < nd ? 1 : 45 < nd ? 2 : 3 : 2 == K ? 3 : 3 == K || 4 == K ? 4 : 0, c = 13;
        else {
          c = a.g;
        ...
        else if ("pcm-bpcm" == a.s) b = 14, c = Math.floor(.2 *
          I) % 4, 3 == c && (c = 1), c *= 2;
    ...
    bf = function (a) {
      ...
      if (0 == td && 0 == ud) Ze(vd, wd);
        ...
        var b = Math.abs(td),
          c = Math.abs(ud);
        8 > b && 8 > c ? Ze(vd, wd) : 15 < b && c < 2 * b / 3 ? E[0].Oa = 0 < td ? 8 : 4 : 15 < c && b < 2 * c / 3 && (E[0].Oa = 0 < ud ? 2 : 1);
      ...
      if (4 == a && 0 == A.$)
        for (var c = 0; c < E.length; c++) {
          ...
          for (c = 0; c < E.length; c++)
            if (d = E[c], d.H) {
              if (64 == a || b || (d.Ib = !0), 4 == a && (d.nb = !1), 8 != d.mode && 16 != d.mode && 32 != d.mode && 128 != d.mode && 64 != d.mode || b) b || 4 == d.mode || d.mode == a || (d.Db = !0), He(d, a)
    ...
    rf = function () {
      ...
      if (O) {
        if (Jd) {
          ...
          b.beginPath();
          for (d = 8; d <= 8 * qd; d += 8)
            for (e = 8; e <= 8 * pd; e += 8) 1 == C[d][e].Pa && b.rect(e + -32 + 10 + 3, d + 0 + 40 + 3, 2, 2);
          b.fill();
          if (Nd)
            for (d = 8; d <= 8 * qd; d += 8)
              for (e = 8; e <= 8 * pd; e += 8) 2 == C[d][e].Pa && (a = e + -32 + 10, c = d + 0 + 40, W(2, 182, 8, 8, a, c));
        ...
        if (Id) {
          ...
          Rd = 0;
          for (a = 280; 472 >= a; a += 8)
            for (c = 0; 136 >= c; c += 8) .03 > Ie() && (Qd = 10 * Math.floor(25 * Ie()), Rd = 10 * Math.floor(2 * Ie())), W(Qd, Rd, 8, 8, a + 10, c + 40), Rd += 8;
          b.restore()
        }
        sf();
    ...
    Pe = function (a) {
      ge && google.doodle.pacManSound && 0 == F && (ee[a] ? fe[a] = !0 : (0 == a ? (Se(1 == Hd[a] ? "eating-dot-1" : "eating-dot-2"), ie = window.setInterval(uf, 150)) : (Se("eating-dot-double"), je = window.setInterval(vf, 150)), Hd[a] = 3 - Hd[a]))
    },
    wf = function (a) {
      ee[a] = !1;
      fe[a] && (fe[a] = !1, Pe(a))
    ...
    function () {
      if (ge && google.doodle.pacManSound) {
        var a = 0;
        0 == F || 1 == F ? a = bd ? "ambient-eyes" : 4 == fd ? "ambient-fright" : 241 < rd ? "ambient-4" : 207 < rd ? "ambient-3" : 138 < rd ? "ambient-2" : "ambient-1" : 13 == F && 0 != zd && (a = "cutscene");
        if (a) {
          var b = !1;
    ...
    kf = function (a) {
      ...
      b && (a += "&ntp=1"); - 1 == a.search("&ei=") && (a += "&ei=", Ec || (window.google && window.google.kEI && window.google.kEI.length ? Ec = window.google.kEI : document.querySelector("body#iframedoodle") &&
